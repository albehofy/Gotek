...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $p1 = Project::create([
            'title' => ['en' => 'Media Glow E-Commerce', 'ar' => 'متجر ميديا جلو الإلكتروني'],
            ...
            'img_alt' => 'Media Glow E-Commerce Project',
            'ViewInHome' => true,
            'color' => '#1a1815',
            'emoji' => '🛍️',
            'tags' => ['E-Commerce', 'Angular', 'Laravel'],
            'client' => 'Media Glow Retail KSA',
            'timeline' => '4 Months',
            'challenge' => [
            ...
            'testimonial' => [
                'text' => 'Media Glow exceeded our expectations. Our sales doubled in the first month!',
                'name' => 'Fahad Al-Mansoori',
                'role' => 'CEO, Media Glow Retail',
        ...
        Testimonial::create([
            ...
            'feedback' => json_encode(['en' => 'Media Glow delivered our project on time and the quality exceeded our expectations. Highly recommended!', 'ar' => 'سلمت ميديا جلو مشروعنا في الوقت المحدد وتجاوزت الجودة توقعاتنا. نوصي بهم بشدة!']),
            'avatar_color' => '#e8620a',
            'rating' => 5
        ]);
        ...
        DB::table('contact_infos')->insert([
            ...
            'emergency_support' => 'support@mediaglow.com',
            'created_at' => now(),
            'updated_at' => now()
        ]);
        // 8. Departments
        ...
        User::firstOrCreate(
            ...
            [
                'name' => 'Media Glow Client Partner',
                'password' => bcrypt('password'),
                'role' => 'client',
                'department_id' => null
            ]
        ...
        $intProject1 = \App\Models\InternalProject::create([
            'title' => 'Media Glow Official Website',
