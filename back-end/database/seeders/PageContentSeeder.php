...
class PageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        PageContent::updateOrCreate(
            ...
            ['content' => [
                'hero' => [
                    'tag' => ['en' => 'Welcome to Gotek', 'ar' => 'مرحباً بكم في جوتيك'],
            ...
            ['content' => [
                ...
                'timeline' => [
                    [
                        ...
                        'description' => ['en' => 'Gotek was born.', 'ar' => 'ولدت جوتيك.']
                    ]
                ]
            ]]
        );
        ...
        PageContent::updateOrCreate(
            ...
            ['content' => [
                ...
                'email' => 'hello@goteksa.com',
                'phone' => '966500000000',
                'copy' => ['en' => '© 2026 Gotek. All rights reserved.', 'ar' => '© 2026 جوتيك. جميع الحقوق محفوظة.'],
                'socials' => [
                    'facebook' => 'https://facebook.com/goteksa',
                    'instagram' => 'https://instagram.com/gotekksa',
                    'twitter' => 'https://x.com/goteksa',
                    'linkedin' => 'https://linkedin.com/company/goteksa'
                ]
            ]]
        );
    }
