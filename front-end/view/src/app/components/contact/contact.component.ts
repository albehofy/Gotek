      ...
      if (res && res.data) {
        ...
        this.contactInfo = [
          ...
          },
          {
            ...
            value: info.official_email || 'contact@goteksa.com',
          ...
          },
          {
            ...
            value: info.emergency_support || 'support@goteksa.com',
        ...
        this.contactInfo = [
          ...
          },
          {
            icon: 'fi fi-rr-envelope',
            label: 'contact_label_email',
            value: 'contact@goteksa.com',
            sub: 'We reply within 24 hours',
            link: { url: 'mailto:contact@goteksa.com', text: 'Send Email →', target: '_self' }
          },
          {
            icon: 'fi fi-rr-marker',
            label: 'Company Address',
