export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    hero_desc:
      'From bold brand identities and high-converting ad campaigns to blazing-fast websites and custom POS systems — Gotek is your all-in-one digital growth partner in Saudi Arabia.',
    ...
    about_desc_1:
      "Gotek combines creative marketing with technical engineering under one roof. Founded on 9+ years of proven success with Media Glow in Egypt, we bring the same excellence to Saudi Arabia's thriving digital market.",
    about_desc_2:
    ...
    cta_desc:
      "Whether it's a brand refresh, aggressive lead generation, or a full digital transformation — Gotek is the partner that delivers.",
  ...
  ar: {
    ...
    hero_title_3: 'الرقمي',
    hero_desc:
      'نبني تجارب رقمية متكاملة تُحقق نتائج قابلة للقياس. من الهوية البصرية والحملات الإعلانية عالية الأداء إلى تطوير الويب وأنظمة نقاط البيع — Gotek شريكك الاستراتيجي للنمو الرقمي.',
    ...
    about_desc_1:
      'نجمع في Gotek بين قوة التسويق الرقمي وعمق التطوير التقني تحت سقف واحد. أسسها مهندسون ومسوّقون بخبرة تتجاوز 9 سنوات عبر Media Glow في مصر، وننقل هذا الإرث الآن إلى السوق السعودي بكل ثقة واحترافية.',
    about_desc_2:
    ...
    cta_desc:
      'سواء أردت تجديد هويتك التجارية، أو تضخيم مبيعاتك، أو التحول الرقمي الشامل — Gotek هي الشريك الذي تثق به.',
    ...
    founder1_desc:
      'مهندس ورجل أعمال متمرس ذو خبرة عميقة في الأنظمة التقنية والاستراتيجية الرقمية. يقود محمد رؤية Gotek للحلول المتكاملة والمبتكرة تقنياً.',
