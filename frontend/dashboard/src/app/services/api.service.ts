...
export class ApiService {
  ...
  updateTaskPriority(id: string | number, priority: string): Observable<any> {
    return this.http.put<any>(`${API_BASE_URL}/tasks/${id}/priority`, { priority }, { headers: this.getHeaders() });
  }
