export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "footer_copy": "© 2026 Media Glow Digital Solutions — mediaglow.com All rights reserved.",
  ...
  ar: {
    ...
    "hero_badge": "وكالة ميديا جلو للدعاية والإعلان والحلول الرقمية · القاهرة - مصر",
    ...
    "contact_map_title": "Media Glow Digital Solutions",
    "contact_map_location": "القاهرة، جمهورية مصر العربية — التجمع الخامس",
