...
function ClientPortalViewComponent_div_0_tr_48_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(5, 8, deal_r1.calculated_total, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(8, 11, deal_r1.calculated_paid, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(11, 14, deal_r1.remaining_balance, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(4);
...
function ClientPortalViewComponent_div_0_div_54_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(13, "i", 39);
    \u0275\u0275text(14, " \u0625\u0636\u0627\u0641\u0629 \u0645\u0644\u0627\u062D\u0638\u0627\u062A \u0648\u062A\u0639\u062F\u064A\u0644\u0627\u062A ");
    \u0275\u0275elementEnd()();
...
function ClientPortalViewComponent_div_0_div_55_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " \u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u062E\u0631\u062C\u0627\u062A \u0623\u0648 \u0645\u0647\u0627\u0645 \u0646\u0634\u0637\u0629 \u0645\u062D\u062F\u062F\u0629 \u0644\u062D\u0633\u0627\u0628\u0643 \u062D\u0627\u0644\u064A\u0627\u064B. ");
    \u0275\u0275elementEnd();
  }
}
function ClientPortalViewComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "i", 3);
    \u0275\u0275text(5, " \u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0639\u0645\u0644\u0627\u0621");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 4);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 5)(9, "div", 6)(10, "span", 7);
    \u0275\u0275text(11, "\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0641\u0648\u0627\u062A\u064A\u0631 \u0648\u0627\u0644\u062E\u062F\u0645\u0627\u062A");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(29, "i", 13);
    \u0275\u0275text(30, " \u0627\u0644\u0639\u0642\u0648\u062F \u0648\u0627\u0644\u0635\u0641\u0642\u0627\u062A \u0627\u0644\u0646\u0634\u0637\u0629");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 14)(32, "table", 15)(33, "thead")(34, "tr")(35, "th");
    \u0275\u0275text(36, "\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0635\u0641\u0642\u0629");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "th");
    \u0275\u0275text(38, "\u0627\u0644\u0642\u064A\u0645\u0629 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A\u0629");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "th");
    \u0275\u0275text(40, "\u0627\u0644\u0645\u0628\u0644\u063A \u0627\u0644\u0645\u062F\u0641\u0648\u0639");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "th");
    \u0275\u0275text(42, "\u0627\u0644\u0631\u0635\u064A\u062F \u0627\u0644\u0645\u062A\u0628\u0642\u064A");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "th");
    \u0275\u0275text(44, "\u0646\u0633\u0628\u0629 \u0627\u0644\u0625\u0646\u062C\u0627\u0632");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(51, "i", 17);
    \u0275\u0275text(52, " \u0627\u0644\u0645\u062E\u0631\u062C\u0627\u062A \u0648\u0627\u0639\u062A\u0645\u0627\u062F\u0627\u062A \u0627\u0644\u0645\u0647\u0627\u0645");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1("\u0623\u0647\u0644\u0627\u064B \u0628\u0643 ", ctx_r6.portalData.client_name, " \u2014 \u0645\u062A\u0627\u0628\u0639\u0629 \u0627\u0644\u0639\u0642\u0648\u062F \u0648\u0627\u0644\u0635\u0641\u0642\u0627\u062A\u060C \u0627\u0644\u0623\u0631\u0635\u062F\u0629 \u0627\u0644\u0645\u0627\u0644\u064A\u0629\u060C \u0648\u0627\u0639\u062A\u0645\u0627\u062F \u0645\u062E\u0631\u062C\u0627\u062A \u0627\u0644\u0639\u0645\u0644");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(14, 7, ctx_r6.portalData.financial_summary.total_billed, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(20, 10, ctx_r6.portalData.financial_summary.total_paid, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(26, 13, ctx_r6.portalData.financial_summary.remaining_balance, "1.2-2"), " \u062C.\u0645");
    \u0275\u0275advance(23);
...
(() => {
  ...
  `, styles: ['/* angular:styles/component:css;883bf536de9ab0c989a98846478d2fd52d5e5ac36eedfc012b175e1e53125b35;/run/media/devoryx/Storage/Media Glow CRM/fontend/dashboard/src/app/components/client-portal/client-portal-view.component.ts */\n:host {\n  display: block;\n  font-family:\n    "Cairo",\n    "Inter",\n    sans-serif;\n  direction: rtl;\n  text-align: right;\n}\n.client-portal-container {\n  padding: 28px 32px;\n  min-height: 100vh;\n  background: var(--bg);\n  background-image: var(--bg-gradient);\n  background-attachment: fixed;\n  direction: rtl;\n  text-align: right;\n}\n.portal-header {\n  margin-bottom: 24px;\n}\n.portal-header h2 {\n  font-size: 1.4rem;\n  font-weight: 800;\n  color: #fff;\n  letter-spacing: -0.3px;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n}\n.subtitle {\n  color: var(--text-2);\n  font-size: 0.85rem;\n  margin-top: 4px;\n}\n.metrics-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));\n  gap: 16px;\n  margin-bottom: 24px;\n}\n.metric-card {\n  padding: 22px;\n  background: var(--bg-card);\n  border: 1px solid var(--border);\n  border-radius: var(--r-lg);\n  position: relative;\n  overflow: hidden;\n}\n.metric-card .label {\n  color: var(--text-2);\n  font-size: 0.68rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 1px;\n  display: block;\n  margin-bottom: 8px;\n}\n.metric-card .value {\n  font-size: 1.8rem;\n  font-weight: 900;\n  letter-spacing: -1px;\n  line-height: 1;\n}\n.crm-table {\n  width: 100%;\n  border-collapse: separate;\n  border-spacing: 0;\n  text-align: right;\n  direction: rtl;\n}\n.crm-table th {\n  text-align: right;\n  padding: 14px 20px;\n  border-bottom: 1px solid rgba(99, 102, 241, 0.18);\n  color: var(--violet-light);\n  font-size: 0.75rem;\n  font-weight: 800;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n  background: rgba(99, 102, 241, 0.05);\n  white-space: nowrap;\n}\n.crm-table td {\n  padding: 14px 16px;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.04);\n  font-size: 0.86rem;\n  color: #fff;\n  vertical-align: middle;\n  text-align: right;\n}\n.crm-table tr:last-child td {\n  border-bottom: none;\n}\n.crm-table tr:hover td {\n  background: rgba(255, 255, 255, 0.015);\n}\n/*# sourceMappingURL=client-portal-view.component.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientPortalViewComponent, { className: "ClientPortalViewComponent", filePath: "src/app/components/client-portal/client-portal-view.component.ts", lineNumber: 137 });
})();
export {
  ClientPortalViewComponent
};
//# sourceMappingURL=chunk-6I2JTK7X.js.map
