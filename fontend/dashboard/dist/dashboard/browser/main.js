...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-NGZGKIHM.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    loadComponent: () => import("./chunk-TGQDM7GV.js").then((m) => m.MainLayoutComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-EKXIFTB6.js").then((m) => m.ControllerDashboardComponent)
      },
      {
        path: "clients",
        loadComponent: () => import("./chunk-3LJTAIGO.js").then((m) => m.ClientsListComponent)
      },
      {
        path: "clients/:id",
        loadComponent: () => import("./chunk-6DYRR6QE.js").then((m) => m.ClientDetailComponent)
      },
      {
        path: "deals",
        loadComponent: () => import("./chunk-CB72NRDZ.js").then((m) => m.DealsManagementComponent)
      },
      {
        path: "tasks",
        loadComponent: () => import("./chunk-YXHASL3T.js").then((m) => m.TasksBoardComponent)
      },
      {
        path: "departments",
        loadComponent: () => import("./chunk-NXQHAP7Z.js").then((m) => m.DepartmentsSectionsComponent)
      },
      {
        path: "finance",
        loadComponent: () => import("./chunk-LCMKQ37C.js").then((m) => m.FinanceDashboardComponent)
      },
      {
        path: "client-portal",
        loadComponent: () => import("./chunk-6I2JTK7X.js").then((m) => m.ClientPortalViewComponent)
      },
      {
        path: "roles",
        loadComponent: () => import("./chunk-PYCRDGAO.js").then((m) => m.RolesManagementComponent)
      }
    ]
  },
  {
