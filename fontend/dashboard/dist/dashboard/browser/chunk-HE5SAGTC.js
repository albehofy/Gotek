...
var ApiService = class _ApiService {
  ...
  getDeals(params = {}) {
    ...
    if (params && typeof params === "object") {
      Object.keys(params).forEach((k) => {
        if (params[k] !== null && params[k] !== void 0 && params[k] !== "") {
          httpParams = httpParams.set(k, params[k]);
        }
      });
    }
    return this.http.get(`${API_BASE_URL}/deals`, { headers: this.getHeaders(), params: httpParams }).pipe(catchError(this.handleError("getDeals", [])));
  }
  getDeal(id) {
  ...
  deleteDeal(id, deleteFinancials = false) {
    const params = new HttpParams().set("delete_financials", deleteFinancials ? "1" : "0");
    return this.http.delete(`${API_BASE_URL}/deals/${id}`, { headers: this.getHeaders(), params });
  }
  // Tasks
  getTasks(params = {}) {
    let httpParams = new HttpParams();
  ...
  deleteTaskAttachment(taskId, attachmentId) {
    return this.http.delete(`${API_BASE_URL}/tasks/${taskId}/attachments/${attachmentId}`, { headers: this.getHeaders() });
  }
  getTaskActivity(taskId) {
    return this.http.get(`${API_BASE_URL}/tasks/${taskId}/activity`, { headers: this.getHeaders() }).pipe(catchError(this.handleError("getTaskActivity", [])));
  }
  createSubtask(parentId, payload) {
    const body = payload instanceof FormData ? payload : typeof payload === "string" ? { title: payload } : payload;
    return this.http.post(`${API_BASE_URL}/tasks/${parentId}/subtasks`, body, { headers: this.getHeaders() });
  }
  toggleSubtask(id) {
    return this.http.put(`${API_BASE_URL}/tasks/subtasks/${id}/toggle`, {}, { headers: this.getHeaders() });
  }
  deleteSubtask(id) {
    return this.http.delete(`${API_BASE_URL}/tasks/subtasks/${id}`, { headers: this.getHeaders() });
  }
  getTaskCustomFields() {
  ...
  getDepartments() {
    ...
    return this.http.get(`${API_BASE_URL}/departments`, { headers: this.getHeaders() }).pipe(catchError(this.handleError("getDepartments", fallbackDepartments)));
  }
  ...
  updateSubCategory(subId, data) {
    return this.http.put(`${API_BASE_URL}/departments/sub-categories/${subId}`, data, { headers: this.getHeaders() });
  }
  deleteSubCategory(subId) {
    return this.http.delete(`${API_BASE_URL}/departments/sub-categories/${subId}`, { headers: this.getHeaders() });
  }
  deleteDepartment(id) {
    return this.http.delete(`${API_BASE_URL}/departments/${id}`, { headers: this.getHeaders() });
  }
  // Users & Roles
  getUsers(paramsOrRole) {
    ...
    if (typeof paramsOrRole === "string") {
      ...
      Object.keys(paramsOrRole).forEach((k) => {
        if (paramsOrRole[k] !== null && paramsOrRole[k] !== void 0 && paramsOrRole[k] !== "") {
  ...
  updateUserDepartment(userId, departmentId) {
    return this.http.patch(`${API_BASE_URL}/users/${userId}/assign-department`, { department_id: departmentId }, { headers: this.getHeaders() });
  }
  deleteUser(id) {
  ...
  getClientBalances(params = {}) {
    ...
    return this.http.get(`${API_BASE_URL}/finance/client-balances`, { headers: this.getHeaders(), params: httpParams }).pipe(catchError(this.handleError("getClientBalances", [])));
  }
  ...
  getClientPortalDashboard() {
    const fallbackPortal = {
      ...
      financial_summary: { total_billed: 15e4, total_paid: 1e5, remaining_balance: 5e4 },
      deals: [
        { id: 1, title: "\u062D\u0645\u0644\u0629 \u0625\u0639\u0644\u0627\u0646\u064A\u0629 \u0648\u062A\u0637\u0648\u064A\u0631 \u0627\u0644\u0647\u0648\u064A\u0629 \u0627\u0644\u0628\u0635\u0631\u064A\u0629", calculated_total: 1e5, calculated_paid: 75e3, remaining_balance: 25e3, progress: 75, status: "\u0646\u0634\u0637" },
        { id: 2, title: "\u0625\u0646\u062A\u0627\u062C \u0641\u064A\u062F\u064A\u0648\u0647\u0627\u062A \u0631\u064A\u0644\u0632 \u0648\u0633\u0648\u0634\u064A\u0627\u0644 \u0645\u064A\u062F\u064A\u0627", calculated_total: 5e4, calculated_paid: 25e3, remaining_balance: 25e3, progress: 50, status: "\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u0646\u0641\u064A\u0630" }
      ],
      tasks: [
    ...
    return this.http.get(`${API_BASE_URL}/client-portal/dashboard`, { headers: this.getHeaders() }).pipe(catchError(this.handleError("getClientPortalDashboard", fallbackPortal)));
  }
...
//# sourceMappingURL=chunk-HE5SAGTC.js.map
